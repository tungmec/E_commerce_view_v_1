...
export const Home = () => {
    ...
    const { authLoading, authenticated, user, setAuthenticated ,checkAuth} = getAuth();
    ...
    if (authLoading) {
        return (
            <div>
                <h2>Loading server for check authenticate .....</h2>
            </div>
        )
    } 
    if (!login && !create && !authenticated && ! authLoading) {
        return (
                <>
    ...
    } else if (login && !authenticated && !authLoading) {
        return (
            <div>
    ...
    } else if (create && !authenticated && !authLoading) {
        return (
            <div>
